        ...
        <div class="topbar">
            ...
            <nav class="navbar-custom">
                <ul class="navbar-right list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list list-inline-item d-none d-md-inline-block"><a class="nav-link waves-effect" href="#" id="btn-fullscreen"><i class="mdi mdi-fullscreen noti-icon"></i></a></li><!-- notification -->
...
<!-- Authentication -->
                        ...
                        <li><a href="javascript:void(0);" class="waves-effect"><i class="ti-email"></i><span>Individual Bus Info <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span></span></a>
                            <ul class="submenu">
                                ...
                                <li><a href="{{ route('bus_duration') }}">Duration</a></li>
